...
namespace MS_lab8
{
    class Program
    {
        ...
        public static void Task1()
        {
            ...
            List<P> places = new List<P>() {  incomingA, generatedA, requestedA, admitedA, sentA, gotB, allGotB,
                                             incomingB, generatedB, requestedB, admitedB, sentB, gotA, allGotA, indicator};
